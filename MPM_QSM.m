...
tstart = tic ;
    ...
    if isempty(para.ph_dir) && isempty(para.mag_dir) %changed from file to dir 
    ...
    createNifti(mag, mag_merged_file, mag_1tp.mat)
        ...
        ph_merged_file = fullfile(ph_fulldir) ; %deleted para.ph_files
        mag_merged_file = fullfile(mag_fulldir) ; %deleted para.mag_files
    end
